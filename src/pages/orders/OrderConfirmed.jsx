      ...
      <div className=" h-screen py-2">
        <div className="container mx-auto lg:px-4 px-0">
          <div className="flex items-center mb-4">
            ...
            <h1 className="lg:text-2xl font-semibold ">Confirmer la commande</h1>
          </div>
          <div className="flex flex-col md:flex-row gap-4">
            <div className="md:w-3/4">
              <div className="bg-white rounded-lg shadow-md lg:p-6 mb-4">
                <table className="w-full max-lg:text-sm">
                  <thead>
                    <tr>
                  ...
                  <tbody>
                    {products?.length > 0 ? (
                      products.map((product, i) => {
                        return (
                          <tr key={product.id}>
                            <td className="py-4 max-lg:text-xs">
                            ...
                            <td className="py-4 text-bold">{product.price}</td>
                            <td className="py-4">
                              <div className="flex items-center">
                                <button
                                  className="border rounded-md md:py-2 md:px-4 py-1 px-3 md:mr-2"
                                  onClick={() => {
                                ...
                                <span className="text-center md:w-8 w-4 select-none">
                                  {quantities[product.id] !== undefined
                                    ? quantities[product.id]
                                    : 1}
                                </span>
                                <button
                                  className="border rounded-md md:py-2 md:px-4 py-1 px-3 md:ml-2"
                                  onClick={() =>
